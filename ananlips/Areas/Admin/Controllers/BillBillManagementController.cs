...
{
    public class BillBillManagementController : CustomController
    {
        #region Tree
        ...
        public ActionResult Create(Bill item)
        {
            ...
            try
            {
                ...
                var isExist = Bill.GetById(item.entryid) ;
        ...
        public ActionResult UpdateActiveStatus(int entryid, bool isactive)
        {
            ...
            try
            {
                var isExist =Bill.GetById(entryid);
