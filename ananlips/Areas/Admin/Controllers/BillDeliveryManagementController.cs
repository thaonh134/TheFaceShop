...
{
    public class BillDeliveryManagementController : CustomController
    {
        #region Tree
        public ActionResult Index(string redirectbyajax, string entryid, string actiontype, string fa)
        {
            ...
            return View("DeliveryManagementTree", dict);
        ...
        public ActionResult Read([DataSourceRequest]DataSourceRequest request, string isactive)
        {
            ...
            var userid = 0;
            var data = new Delivery().GetPage(request, whereCondition, isactive, userid);
            return Json(data);
        }
        ...
        public ActionResult FormPopup(string entryid, string entrykey, string redirectbyajax)
        {
            ...
            return View("DeliveryManagementForm", dict);


        }

        [HttpPost]
        public ActionResult Create(Delivery item)
        {
            ...
            try
            {
                ...
                var isExist = Delivery.GetById(item.entryid) ;
        ...
        public ActionResult UpdateActiveStatus(int entryid, bool isactive)
        {
            ...
            try
            {
                var isExist =Delivery.GetById(entryid);
        ...
        public ActionResult GetByID(int entryid)
        {
            ...
            try
            {
                var data =Delivery.GetById(entryid);
